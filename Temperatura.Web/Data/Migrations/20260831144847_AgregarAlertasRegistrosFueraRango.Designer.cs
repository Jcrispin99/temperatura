...
namespace Temperatura.Web.Data.Migrations
{
    ...
    [Migration("20260831144847_AgregarAlertasRegistrosFueraRango")]
    partial class AgregarAlertasRegistrosFueraRango
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Temperatura.Web.Domain.Horario", b =>
                {
                    ...
                    b.Property<string>("MomentoOperativo")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("Horarios", null, t =>
                        {
                            t.HasCheckConstraint("CK_Horarios_MomentoOperativo", "[MomentoOperativo] IN ('Manana', 'Mediodia', 'Noche', 'Medianoche')");
                        });
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Activo = true,
                            EsCierreDiaOperativoAnterior = false,
                            HoraReferencia = new TimeOnly(13, 0, 0),
                            MomentoOperativo = "Mediodia",
                            Nombre = "13:00"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            HoraReferencia = new TimeOnly(1, 0, 0),
                            MomentoOperativo = "Medianoche",
                            Nombre = "01:00"
                        });
                });
            ...
            modelBuilder.Entity("Temperatura.Web.Domain.Registro", b =>
                {
                    ...
                    b.Property<bool>("EsCierreDiaOperativoAnteriorAplicado")
                        .HasColumnType("bit");
                    ...
                    b.Property<TimeOnly>("HoraReferenciaAplicada")
                        .HasColumnType("time");

                    b.Property<int>("HorarioId")
                        .HasColumnType("int");

                    b.Property<string>("HorarioNombreAplicado")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("MomentoOperativoAplicado")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("Registros", null, t =>
                        {
                            t.HasCheckConstraint("CK_Registros_MomentoOperativoAplicado", "[MomentoOperativoAplicado] IN ('Manana', 'Mediodia', 'Noche', 'Medianoche')");
                        });
                });
